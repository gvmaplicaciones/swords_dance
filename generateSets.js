...
// Ejecutar: ANTHROPIC_API_KEY=xxx SUPABASE_URL=xxx SUPABASE_KEY=xxx node scripts/generateSets.js
//
// Requisitos previos:
//   1. downloadMoves.js ya ejecutado — tabla moves y pokemon_moves en Supabase
//   2. API key de Anthropic (console.anthropic.com)
//   3. npm install @anthropic-ai/sdk @supabase/supabase-js
...
const supabase  = createClient(
  process.env.SUPABASE_URL  || "https://xfgkqrxzsmdjmzozfoer.supabase.co",
